...
p_df.groupBy('Population_Below_National_Poverty_Line').mean().show()

desc_group = p_df.groupBy('Population_Below_National_Poverty_Line').agg({col: 'mean' for col in selected_cols})
desc_group.show()
